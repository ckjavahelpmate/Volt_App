...
<body>
	<div class="navbar">
		...
		<a href="home.jsp">Home</a> <a href="about.jsp">About</a> <a
			href="displayImages.jsp">Images</a> <a href="logout.jsp">Logout</a> <a
			href="profile.jsp"
	...
	<div class="container">
		...
		try {
			...
			query = "Select * from files where userid = ? && filetype='video'";
		...
		<table>
			...
			<tr>
				...
				String path = "C:/Users/QJspiders/eclipse-workspace/Personal/Volt App/src/main/webapp/videos/"
						+ rs.getString("filename");
				FileOutputStream fout = new FileOutputStream(path);
				fout.write(b);
				fout.close();
				%>
				<td><video width="30%" autoplay="autoplay" muted="muted">
						<source src="./videos/<%=filename%>" type="video/mp4">
						<source src="./videos/<%=filename%>" type="video/ogg">
					</video></td>
				<td><a href="./videos/<%=filename%>" download> <%=filename%>
				</a></td>
			</tr>
